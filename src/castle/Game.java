...
public class Game {
	...
	private void createRooms() {
		// 配置互逆方向
		this.addReverseDirection("left", "right").addReverseDirection("top", "bottom").addReverseDirection("up",
				"down");
		// 制造房间
		...
		// 配置相对关系
		this.setRoomExit(roomA, "right", roomB).setRoomExit(roomB, "right", roomC).setRoomExit(roomC, "top", roomD);
